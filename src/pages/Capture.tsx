...
export default function Capture() {
  ...
  const handleSaveNote = async () => {
    ...
    try {
      ...
      // Simulate AI processing and update via secure edge function
      setTimeout(async () => {
        const { data: processedData, error: processError } = await supabase.functions.invoke('process-note', {
          body: {
            note_id: note.id,
            status: "ready",
        ...
        if (!processedData?.note) throw new Error('Failed to process note');
